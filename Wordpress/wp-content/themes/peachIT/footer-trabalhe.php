					...
					<div class="row">
						...
						<div class="col-12 col-md-3 coluna-3 order-0 order-md-last">
							...
							<div class="contato">
								<ul>
									<li>
										<img src="<?php echo get_stylesheet_directory_uri(); ?>/images/icons/email.svg" alt="Email Peach IT"> <a href="mailto:rh@peachit.com.br?subject=Trabalhe" target="_blank">rh@peachit.com.br</a>
									</li>
									<li>
				...
				<div class="modal-content">
					<div class="modal-body">
						...
						<div class="row">
							...
							<div class="col-md-8">
								<div class="right">
									<?php echo do_shortcode( '[contact-form-7 id="118" title="Trabalhe Conosco"]' ); ?>
								</div>
							</div>
						</div>
					</div>
		...
		<!-- App JS -->
		<script src="<?php echo get_stylesheet_directory_uri(); ?>/js/app.js?v=1.8"></script>
	</body>
</html>